...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS groupUsers(gid INTEGER, uid INTEGER, balance REAL,  Primary Key (uid, gid), FOREIGN KEY(gid) REFERENCES groups(gid), FOREIGN KEY(uid) REFERENCES users(uid))");
        ...
        db.execSQL("INSERT INTO " + TB_NAME_USERS + "(" + ID + "," + USERNAME + "," + PASSWORD + ") VALUES" + "('1','admin','admin')");
        db.execSQL("INSERT INTO " + TB_NAME_USERS + "(" + ID + "," + USERNAME + "," + PASSWORD + ") VALUES" + "('2','alex','alex')");
        db.execSQL("INSERT INTO " + TB_NAME_USERS + "(" + ID + "," + USERNAME + "," + PASSWORD + ") VALUES" + "('3','groot','groot')");
    }
