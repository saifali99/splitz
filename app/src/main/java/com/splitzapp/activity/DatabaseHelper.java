...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS groupExpense(eid INTEGER PRIMARY KEY AUTOINCREMENT, gid INTEGER, uid INTEGER, expense INTEGER, FOREIGN KEY(gid) references groups(gid), FOREIGN KEY(uid) references users(id))");
